...
string OrgUser::registerUsers(){
    ...
    {
        return "! This User Name Is Command Line You Please Try Again";
    }
   ...
   if (regex_match(getMobile(), pattern)) {
       ...
       return "! Invalid Moblie! Mobile Number Must Like +98-123456789" ;
       }
           ...
           string pass=getPassword();
            ...
            if (outFile.is_open()) {
                    ...
                    outFile << getBoss() << std::endl;
                    outFile << "Organisation" << std::endl;
            ...
            if (outFile2.is_open()) {
                    ...
                    outFile2 << "BioGraphy Test (Limit 1110)" << std::endl;
                    outFile2.close();
...
void OrgUser::setBoss(std::string _boss){

    boss=_boss;
}
std::string OrgUser::getBoss(){
